...
# automobile_kedro documentation build
...
from automobile_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "automobile_kedro"
author = "Kedro"
...
htmlhelp_basename = "automobile_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "automobile_kedro.tex",
        "automobile_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "automobile_kedro",
        "Project automobile_kedro codebase.",
        "Data-Science",
    )
]
